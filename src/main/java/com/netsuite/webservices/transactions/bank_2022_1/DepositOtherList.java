...
public class DepositOtherList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.bank_2022_1.DepositOther[] depositOther;
    ...
    public DepositOtherList(
           com.netsuite.webservices.transactions.bank_2022_1.DepositOther[] depositOther,
           boolean replaceAll) {
     ...
     * @return depositOther
     */
    public com.netsuite.webservices.transactions.bank_2022_1.DepositOther[] getDepositOther() {
        return depositOther;
    }
     ...
     * @param depositOther
     */
    public void setDepositOther(com.netsuite.webservices.transactions.bank_2022_1.DepositOther[] depositOther) {
        this.depositOther = depositOther;
    }

    public com.netsuite.webservices.transactions.bank_2022_1.DepositOther getDepositOther(int i) {
        return this.depositOther[i];
    }

    public void setDepositOther(int i, com.netsuite.webservices.transactions.bank_2022_1.DepositOther _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:bank_2022_1.transactions.webservices.netsuite.com", "DepositOtherList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:bank_2022_1.transactions.webservices.netsuite.com", "depositOther"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:bank_2022_1.transactions.webservices.netsuite.com", "DepositOther"));

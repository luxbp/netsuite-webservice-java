...
public class PurchaseOrderExpenseList  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.purchases_2022_1.PurchaseOrderExpense[] expense;
    ...
    public PurchaseOrderExpenseList(
           com.netsuite.webservices.transactions.purchases_2022_1.PurchaseOrderExpense[] expense,
           boolean replaceAll) {
     ...
     * @return expense
     */
    public com.netsuite.webservices.transactions.purchases_2022_1.PurchaseOrderExpense[] getExpense() {
        return expense;
    }
     ...
     * @param expense
     */
    public void setExpense(com.netsuite.webservices.transactions.purchases_2022_1.PurchaseOrderExpense[] expense) {
        this.expense = expense;
    }

    public com.netsuite.webservices.transactions.purchases_2022_1.PurchaseOrderExpense getExpense(int i) {
        return this.expense[i];
    }

    public void setExpense(int i, com.netsuite.webservices.transactions.purchases_2022_1.PurchaseOrderExpense _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2022_1.transactions.webservices.netsuite.com", "PurchaseOrderExpenseList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:purchases_2022_1.transactions.webservices.netsuite.com", "PurchaseOrderExpense"));

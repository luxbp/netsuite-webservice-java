...
public class TransactionLineType implements java.io.Serializable {
    ...
    public static final TransactionLineType _outsourcingCharge = new TransactionLineType(__outsourcingCharge);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2022_2.transactions.webservices.netsuite.com", "TransactionLineType"));
    }
    /**

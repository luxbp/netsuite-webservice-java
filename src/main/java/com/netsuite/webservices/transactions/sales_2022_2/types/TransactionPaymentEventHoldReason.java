...
public class TransactionPaymentEventHoldReason implements java.io.Serializable {
    ...
    public static final java.lang.String __forwardToAuthenticateDevice = "_forwardToAuthenticateDevice";
    public static final java.lang.String __forwardToChallengeShopper = "_forwardToChallengeShopper";
    ...
    public static final java.lang.String __insufficientFunds = "_insufficientFunds";
    ...
    public static final TransactionPaymentEventHoldReason _forwardToAuthenticateDevice = new TransactionPaymentEventHoldReason(__forwardToAuthenticateDevice);
    public static final TransactionPaymentEventHoldReason _forwardToChallengeShopper = new TransactionPaymentEventHoldReason(__forwardToChallengeShopper);
    ...
    public static final TransactionPaymentEventHoldReason _insufficientFunds = new TransactionPaymentEventHoldReason(__insufficientFunds);
    public static final TransactionPaymentEventHoldReason _notRequired = new TransactionPaymentEventHoldReason(__notRequired);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2022_2.transactions.webservices.netsuite.com", "TransactionPaymentEventHoldReason"));
    }
    /**

...
public class TransactionPaymentEventType implements java.io.Serializable {
    ...
    public static final java.lang.String __authentication = "_authentication";
    ...
    public static final TransactionPaymentEventType _authentication = new TransactionPaymentEventType(__authentication);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2022_2.transactions.webservices.netsuite.com", "TransactionPaymentEventType"));
    }
    /**

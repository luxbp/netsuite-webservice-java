...
public class TransactionType implements java.io.Serializable {
    ...
    public static final java.lang.String __customPurchase = "_customPurchase";
    public static final java.lang.String __customSale = "_customSale";
    ...
    public static final TransactionType _customPurchase = new TransactionType(__customPurchase);
    public static final TransactionType _customSale = new TransactionType(__customSale);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2022_2.transactions.webservices.netsuite.com", "TransactionType"));
    }
    /**

...
public class ItemSupplyReplenishmentMethod implements java.io.Serializable {
    ...
    public static final java.lang.String __masterProductionScheduling = "_masterProductionScheduling";
    public static final java.lang.String __materialRequirementsPlanning = "_materialRequirementsPlanning";
    ...
    public static final ItemSupplyReplenishmentMethod _masterProductionScheduling = new ItemSupplyReplenishmentMethod(__masterProductionScheduling);
    public static final ItemSupplyReplenishmentMethod _materialRequirementsPlanning = new ItemSupplyReplenishmentMethod(__materialRequirementsPlanning);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2022_2.lists.webservices.netsuite.com", "ItemSupplyReplenishmentMethod"));
    }
    /**

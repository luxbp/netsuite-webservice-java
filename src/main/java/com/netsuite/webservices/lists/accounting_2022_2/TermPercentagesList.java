...
public class TermPercentagesList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2022_2.TermPercentages[] termPercentages;
    ...
    public TermPercentagesList(
           com.netsuite.webservices.lists.accounting_2022_2.TermPercentages[] termPercentages,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2022_2.TermPercentages[] getTermPercentages() {
        return termPercentages;
    }
     ...
     */
    public void setTermPercentages(com.netsuite.webservices.lists.accounting_2022_2.TermPercentages[] termPercentages) {
        this.termPercentages = termPercentages;
    }

    public com.netsuite.webservices.lists.accounting_2022_2.TermPercentages getTermPercentages(int i) {
        return this.termPercentages[i];
    }

    public void setTermPercentages(int i, com.netsuite.webservices.lists.accounting_2022_2.TermPercentages _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_2.lists.webservices.netsuite.com", "TermPercentagesList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2022_2.lists.webservices.netsuite.com", "termPercentages"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_2.lists.webservices.netsuite.com", "TermPercentages"));

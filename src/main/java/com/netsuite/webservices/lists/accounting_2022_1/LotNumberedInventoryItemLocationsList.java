...
public class LotNumberedInventoryItemLocationsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2022_1.LotNumberedInventoryItemLocations[] locations;
    ...
    public LotNumberedInventoryItemLocationsList(
           com.netsuite.webservices.lists.accounting_2022_1.LotNumberedInventoryItemLocations[] locations,
           boolean replaceAll) {
     ...
     * @return locations
     */
    public com.netsuite.webservices.lists.accounting_2022_1.LotNumberedInventoryItemLocations[] getLocations() {
        return locations;
    }
     ...
     * @param locations
     */
    public void setLocations(com.netsuite.webservices.lists.accounting_2022_1.LotNumberedInventoryItemLocations[] locations) {
        this.locations = locations;
    }

    public com.netsuite.webservices.lists.accounting_2022_1.LotNumberedInventoryItemLocations getLocations(int i) {
        return this.locations[i];
    }

    public void setLocations(int i, com.netsuite.webservices.lists.accounting_2022_1.LotNumberedInventoryItemLocations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "LotNumberedInventoryItemLocationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "LotNumberedInventoryItemLocations"));

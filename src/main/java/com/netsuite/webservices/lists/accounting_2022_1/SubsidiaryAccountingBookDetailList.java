...
public class SubsidiaryAccountingBookDetailList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2022_1.SubsidiaryAccountingBookDetail[] subsidiaryAccountingBookDetail;
    ...
    public SubsidiaryAccountingBookDetailList(
           com.netsuite.webservices.lists.accounting_2022_1.SubsidiaryAccountingBookDetail[] subsidiaryAccountingBookDetail,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.accounting_2022_1.SubsidiaryAccountingBookDetail[] getSubsidiaryAccountingBookDetail() {
        return subsidiaryAccountingBookDetail;
    }
     ...
     */
    public void setSubsidiaryAccountingBookDetail(com.netsuite.webservices.lists.accounting_2022_1.SubsidiaryAccountingBookDetail[] subsidiaryAccountingBookDetail) {
        this.subsidiaryAccountingBookDetail = subsidiaryAccountingBookDetail;
    }

    public com.netsuite.webservices.lists.accounting_2022_1.SubsidiaryAccountingBookDetail getSubsidiaryAccountingBookDetail(int i) {
        return this.subsidiaryAccountingBookDetail[i];
    }

    public void setSubsidiaryAccountingBookDetail(int i, com.netsuite.webservices.lists.accounting_2022_1.SubsidiaryAccountingBookDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "SubsidiaryAccountingBookDetailList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "subsidiaryAccountingBookDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "SubsidiaryAccountingBookDetail"));

...
public class SerializedInventoryItemLocationsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2022_1.SerializedInventoryItemLocations[] locations;
    ...
    public SerializedInventoryItemLocationsList(
           com.netsuite.webservices.lists.accounting_2022_1.SerializedInventoryItemLocations[] locations,
           boolean replaceAll) {
     ...
     * @return locations
     */
    public com.netsuite.webservices.lists.accounting_2022_1.SerializedInventoryItemLocations[] getLocations() {
        return locations;
    }
     ...
     * @param locations
     */
    public void setLocations(com.netsuite.webservices.lists.accounting_2022_1.SerializedInventoryItemLocations[] locations) {
        this.locations = locations;
    }

    public com.netsuite.webservices.lists.accounting_2022_1.SerializedInventoryItemLocations getLocations(int i) {
        return this.locations[i];
    }

    public void setLocations(int i, com.netsuite.webservices.lists.accounting_2022_1.SerializedInventoryItemLocations _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "SerializedInventoryItemLocationsList"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "SerializedInventoryItemLocations"));

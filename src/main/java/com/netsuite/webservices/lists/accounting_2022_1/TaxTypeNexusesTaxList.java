...
public class TaxTypeNexusesTaxList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2022_1.TaxTypeNexusesTax[] nexusesTax;
    ...
    public TaxTypeNexusesTaxList(
           com.netsuite.webservices.lists.accounting_2022_1.TaxTypeNexusesTax[] nexusesTax,
           boolean replaceAll) {
     ...
     * @return nexusesTax
     */
    public com.netsuite.webservices.lists.accounting_2022_1.TaxTypeNexusesTax[] getNexusesTax() {
        return nexusesTax;
    }
     ...
     * @param nexusesTax
     */
    public void setNexusesTax(com.netsuite.webservices.lists.accounting_2022_1.TaxTypeNexusesTax[] nexusesTax) {
        this.nexusesTax = nexusesTax;
    }

    public com.netsuite.webservices.lists.accounting_2022_1.TaxTypeNexusesTax getNexusesTax(int i) {
        return this.nexusesTax[i];
    }

    public void setNexusesTax(int i, com.netsuite.webservices.lists.accounting_2022_1.TaxTypeNexusesTax _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "TaxTypeNexusesTaxList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "nexusesTax"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "TaxTypeNexusesTax"));

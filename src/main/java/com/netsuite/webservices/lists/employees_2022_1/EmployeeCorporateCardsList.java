...
public class EmployeeCorporateCardsList  implements java.io.Serializable {
    private com.netsuite.webservices.lists.employees_2022_1.EmployeeCorporateCards[] corporateCards;
    ...
    public EmployeeCorporateCardsList(
           com.netsuite.webservices.lists.employees_2022_1.EmployeeCorporateCards[] corporateCards,
           boolean replaceAll) {
     ...
     */
    public com.netsuite.webservices.lists.employees_2022_1.EmployeeCorporateCards[] getCorporateCards() {
        return corporateCards;
    }
     ...
     */
    public void setCorporateCards(com.netsuite.webservices.lists.employees_2022_1.EmployeeCorporateCards[] corporateCards) {
        this.corporateCards = corporateCards;
    }

    public com.netsuite.webservices.lists.employees_2022_1.EmployeeCorporateCards getCorporateCards(int i) {
        return this.corporateCards[i];
    }

    public void setCorporateCards(int i, com.netsuite.webservices.lists.employees_2022_1.EmployeeCorporateCards _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2022_1.lists.webservices.netsuite.com", "EmployeeCorporateCardsList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2022_1.lists.webservices.netsuite.com", "corporateCards"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:employees_2022_1.lists.webservices.netsuite.com", "EmployeeCorporateCards"));

...
public class InitializeAuxRefType implements java.io.Serializable {
    ...
    public static final java.lang.String _tranType = "tranType";
    ...
    public static final InitializeAuxRefType tranType = new InitializeAuxRefType(_tranType);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "InitializeAuxRefType"));
    }
    /**

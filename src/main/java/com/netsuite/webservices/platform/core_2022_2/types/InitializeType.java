...
public class InitializeType implements java.io.Serializable {
    ...
    public static final InitializeType customPurchase = new InitializeType(_customPurchase);
    public static final InitializeType customSale = new InitializeType(_customSale);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "InitializeType"));
    }
    /**

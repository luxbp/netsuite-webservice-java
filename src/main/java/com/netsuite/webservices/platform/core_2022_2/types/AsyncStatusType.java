...
public class AsyncStatusType implements java.io.Serializable {
    ...
    public static final java.lang.String _retry = "retry";
    ...
    public static final AsyncStatusType retry = new AsyncStatusType(_retry);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "AsyncStatusType"));
    }
    /**

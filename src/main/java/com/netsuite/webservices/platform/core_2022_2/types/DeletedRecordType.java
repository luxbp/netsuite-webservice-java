...
public class DeletedRecordType implements java.io.Serializable {
    ...
    public static final java.lang.String _customPurchase = "customPurchase";
    public static final java.lang.String _customRecord = "customRecord";
    public static final java.lang.String _customSale = "customSale";
    ...
    public static final DeletedRecordType customPurchase = new DeletedRecordType(_customPurchase);
    public static final DeletedRecordType customRecord = new DeletedRecordType(_customRecord);
    public static final DeletedRecordType customSale = new DeletedRecordType(_customSale);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "DeletedRecordType"));
    }
    /**

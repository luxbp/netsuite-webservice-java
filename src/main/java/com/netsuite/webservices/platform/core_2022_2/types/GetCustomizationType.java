...
public class GetCustomizationType implements java.io.Serializable {
    ...
    public static final GetCustomizationType customRecordCustomField = new GetCustomizationType(_customRecordCustomField);
    public static final GetCustomizationType customRecordType = new GetCustomizationType(_customRecordType);
    public static final GetCustomizationType customSegment = new GetCustomizationType(_customSegment);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "GetCustomizationType"));
    }
    /**

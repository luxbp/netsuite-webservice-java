...
public class InitializeRefType implements java.io.Serializable {
    ...
    public static final InitializeRefType customPurchase = new InitializeRefType(_customPurchase);
    public static final InitializeRefType customSale = new InitializeRefType(_customSale);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "InitializeRefType"));
    }
    /**

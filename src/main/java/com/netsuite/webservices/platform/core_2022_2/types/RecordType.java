...
public class RecordType implements java.io.Serializable {
    ...
    public static final RecordType customPurchase = new RecordType(_customPurchase);
    ...
    public static final RecordType customSale = new RecordType(_customSale);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2022_2.platform.webservices.netsuite.com", "RecordType"));
    }
    /**

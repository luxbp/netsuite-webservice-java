...
package com.netsuite.webservices.platform.faults_2022_1.types;
...
public class FaultCodeType implements java.io.Serializable {
    ...
    public static final java.lang.String _WS_REQUEST_BLOCKED = "WS_REQUEST_BLOCKED";
    ...
    public static final FaultCodeType INSUFFICIENT_PERMISSION = new FaultCodeType(_INSUFFICIENT_PERMISSION);
    ...
    public static final FaultCodeType WS_REQUEST_BLOCKED = new FaultCodeType(_WS_REQUEST_BLOCKED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.faults_2022_1.platform.webservices.netsuite.com", "FaultCodeType"));
    }
    /**

...
public class PaymentOptionSearchBasic  extends com.netsuite.webservices.platform.core_2022_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2022_1.platform.webservices.netsuite.com", "PaymentOptionSearchBasic"));

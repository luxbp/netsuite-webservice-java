...
public class SearchMultiSelectField  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2022_1.RecordRef[] searchValue;
    ...
    public SearchMultiSelectField(
           com.netsuite.webservices.platform.core_2022_1.RecordRef[] searchValue,
     ...
     * @return searchValue
     */
    public com.netsuite.webservices.platform.core_2022_1.RecordRef[] getSearchValue() {
        return searchValue;
    }
     ...
     * @param searchValue
     */
    public void setSearchValue(com.netsuite.webservices.platform.core_2022_1.RecordRef[] searchValue) {
        this.searchValue = searchValue;
    }

    public com.netsuite.webservices.platform.core_2022_1.RecordRef getSearchValue(int i) {
        return this.searchValue[i];
    }

    public void setSearchValue(int i, com.netsuite.webservices.platform.core_2022_1.RecordRef _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2022_1.platform.webservices.netsuite.com", "SearchMultiSelectField"));

...
public class BooleanCustomFieldRef  extends com.netsuite.webservices.platform.core_2022_1.CustomFieldRef  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2022_1.platform.webservices.netsuite.com", "BooleanCustomFieldRef"));

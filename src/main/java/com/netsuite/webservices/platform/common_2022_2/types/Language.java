...
package com.netsuite.webservices.platform.common_2022_2.types;
...
public class Language implements java.io.Serializable {
    ...
    public static final java.lang.String __afrikaans = "_afrikaans";
    public static final java.lang.String __albanian = "_albanian";
    public static final java.lang.String __arabic = "_arabic";
    public static final java.lang.String __armenian = "_armenian";
    public static final java.lang.String __bengali = "_bengali";
    public static final java.lang.String __bosnian = "_bosnian";
    ...
    public static final java.lang.String __englishAu = "_englishAu";
    public static final java.lang.String __englishCa = "_englishCa";
    public static final java.lang.String __englishInternational = "_englishInternational";
    public static final java.lang.String __englishUK = "_englishUK";
    public static final java.lang.String __englishUS = "_englishUS";
    public static final java.lang.String __estonian = "_estonian";
    public static final java.lang.String __filipino = "_filipino";
    ...
    public static final java.lang.String __gujarati = "_gujarati";
    public static final java.lang.String __haitian = "_haitian";
    public static final java.lang.String __hebrew = "_hebrew";
    public static final java.lang.String __hindi = "_hindi";
    ...
    public static final java.lang.String __kannada = "_kannada";
    ...
    public static final java.lang.String __luxembourgish = "_luxembourgish";
    public static final java.lang.String __malay = "_malay";
    public static final java.lang.String __marathi = "_marathi";
    public static final java.lang.String __norwegian = "_norwegian";
    public static final java.lang.String __persianIran = "_persianIran";
    ...
    public static final java.lang.String __punjabi = "_punjabi";
    public static final java.lang.String __romanian = "_romanian";
    public static final java.lang.String __russian = "_russian";
    public static final java.lang.String __serbianCyrillic = "_serbianCyrillic";
    public static final java.lang.String __serbianLatin = "_serbianLatin";
    ...
    public static final java.lang.String __tamil = "_tamil";
    public static final java.lang.String __telugu = "_telugu";
    public static final java.lang.String __thai = "_thai";
    public static final java.lang.String __turkish = "_turkish";
    public static final java.lang.String __ukrainian = "_ukrainian";
    public static final java.lang.String __vietnamese = "_vietnamese";
    public static final Language _afrikaans = new Language(__afrikaans);
    public static final Language _albanian = new Language(__albanian);
    public static final Language _arabic = new Language(__arabic);
    public static final Language _armenian = new Language(__armenian);
    public static final Language _bengali = new Language(__bengali);
    public static final Language _bosnian = new Language(__bosnian);
    ...
    public static final Language _englishAu = new Language(__englishAu);
    public static final Language _englishCa = new Language(__englishCa);
    public static final Language _englishInternational = new Language(__englishInternational);
    public static final Language _englishUK = new Language(__englishUK);
    public static final Language _englishUS = new Language(__englishUS);
    public static final Language _estonian = new Language(__estonian);
    public static final Language _filipino = new Language(__filipino);
    ...
    public static final Language _gujarati = new Language(__gujarati);
    public static final Language _haitian = new Language(__haitian);
    public static final Language _hebrew = new Language(__hebrew);
    public static final Language _hindi = new Language(__hindi);
    ...
    public static final Language _kannada = new Language(__kannada);
    ...
    public static final Language _luxembourgish = new Language(__luxembourgish);
    public static final Language _malay = new Language(__malay);
    public static final Language _marathi = new Language(__marathi);
    public static final Language _norwegian = new Language(__norwegian);
    public static final Language _persianIran = new Language(__persianIran);
    ...
    public static final Language _punjabi = new Language(__punjabi);
    ...
    public static final Language _serbianCyrillic = new Language(__serbianCyrillic);
    public static final Language _serbianLatin = new Language(__serbianLatin);
    ...
    public static final Language _tamil = new Language(__tamil);
    public static final Language _telugu = new Language(__telugu);
    public static final Language _thai = new Language(__thai);
    public static final Language _turkish = new Language(__turkish);
    public static final Language _ukrainian = new Language(__ukrainian);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.common_2022_2.platform.webservices.netsuite.com", "Language"));
    }
    /**

...
public class PayrollItemSearchRowBasic  extends com.netsuite.webservices.platform.core_2022_2.SearchRowBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] expenseAccount;
    ...
    private com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] itemTypeNoHierarchy;

    private com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] liabilityAccount;
    ...
    private com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] vendor;
    ...
    public PayrollItemSearchRowBasic(
           com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] expenseAccount,
           ...
           com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] itemTypeNoHierarchy,
           com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] liabilityAccount,
           ...
           com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] vendor,
     ...
     */
    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] getExpenseAccount() {
        return expenseAccount;
    }
     ...
     */
    public void setExpenseAccount(com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] expenseAccount) {
        this.expenseAccount = expenseAccount;
    }

    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField getExpenseAccount(int i) {
        return this.expenseAccount[i];
    }

    public void setExpenseAccount(int i, com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField _value) {
     ...
     */
    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] getItemTypeNoHierarchy() {
        return itemTypeNoHierarchy;
    }
     ...
     */
    public void setItemTypeNoHierarchy(com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] itemTypeNoHierarchy) {
        this.itemTypeNoHierarchy = itemTypeNoHierarchy;
    }

    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField getItemTypeNoHierarchy(int i) {
        return this.itemTypeNoHierarchy[i];
    }

    public void setItemTypeNoHierarchy(int i, com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField _value) {
     ...
     */
    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] getLiabilityAccount() {
        return liabilityAccount;
    }
     ...
     */
    public void setLiabilityAccount(com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] liabilityAccount) {
        this.liabilityAccount = liabilityAccount;
    }

    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField getLiabilityAccount(int i) {
        return this.liabilityAccount[i];
    }

    public void setLiabilityAccount(int i, com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField _value) {
     ...
     * @return vendor
     */
    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] getVendor() {
        return vendor;
    }
     ...
     * @param vendor
     */
    public void setVendor(com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField[] vendor) {
        this.vendor = vendor;
    }

    public com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField getVendor(int i) {
        return this.vendor[i];
    }

    public void setVendor(int i, com.netsuite.webservices.platform.core_2022_2.SearchColumnStringField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2022_2.platform.webservices.netsuite.com", "PayrollItemSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2022_2.platform.webservices.netsuite.com", "itemTypeNoHierarchy"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2022_2.platform.webservices.netsuite.com", "SearchColumnStringField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);

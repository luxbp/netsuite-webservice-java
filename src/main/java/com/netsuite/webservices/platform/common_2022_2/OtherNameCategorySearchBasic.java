...
public class OtherNameCategorySearchBasic  extends com.netsuite.webservices.platform.core_2022_2.SearchRecordBasic  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2022_2.platform.webservices.netsuite.com", "OtherNameCategorySearchBasic"));

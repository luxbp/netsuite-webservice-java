...
public class CustomRecordTypePermissionsRestriction implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.customization_2022_1.setup.webservices.netsuite.com", "CustomRecordTypePermissionsRestriction"));
    }
    /**
